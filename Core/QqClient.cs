...
namespace SS.Login.Core
{
    ...
    public class QqClient
    {
        ...
        public QqClient(string appId, string appKey, string redirectUrl)
        {
            AppId = appId;
            AppKey = appKey;
            RedirectUrl = $"{LoginPlugin.Instance.PluginApi.GetPluginApiUrl(nameof(StlLogin.OAuthRedirect), OAuthType.Qq.Value)}?redirectUrl={HttpUtility.UrlEncode(redirectUrl)}";
        }
