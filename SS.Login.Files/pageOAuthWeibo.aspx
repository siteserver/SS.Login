<%@ Page Language="C#" Inherits="SS.Login.Pages.PageOAuthWeibo" %>
  <!DOCTYPE html>
  <html>
      ...
      <div class="card-box">
        ...
        <div class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">是否启用微博登录</label>
            <div class="col-sm-3">
          ...
          <asp:PlaceHolder id="PhSettings" runat="server">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <asp:TextBox id="TbAppKey" class="form-control" runat="server"></asp:TextBox>
              </div>
